...
class ScreenMemberProfile extends StatefulWidget {
  const ScreenMemberProfile({Key? key}) : super(key: key);

  @override
  State<ScreenMemberProfile> createState() => _ScreenMemberProfileState();
}

class _ScreenMemberProfileState extends State<ScreenMemberProfile> {
  @override
  void initState() {
            ...
            child: Column(
              children: <Widget>[
                ...
                const CallToAction(
                  ...
                  txtBtn: "Modifier mes informations",
                ),
              ],
            ),
          )
